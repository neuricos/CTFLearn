...
Use `jadx` to decompile the application, we can find the following parser file:
...
Obviously, when a certain condition is met, the app is going to output the flag. Hence, we can use the following script to generate the flag:

```python
#!/usr/bin/env python3

char_codes = [1407, 1397, 1400, 1406, 1346, 1400, 1385, 1394, 1382, 1293, 1367, 1368, 1365, 1344, 1354, 1288, 1354, 1382, 1288, 1354, 1382, 1355, 1293, 1357, 1361, 1290, 1355, 1382, 1290, 1368, 1354, 1344, 1382, 1288, 1354, 1367, 1357, 1382, 1288, 1357, 1348]
chars = [chr(c ^ 1337) for c in char_codes]
flag = "".join(chars)
print(f"flag = {flag}")
```
